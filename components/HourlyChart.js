...
export default function HourlyChart({ buckets, unitLabel }) {
  ...
  return (
    <div className="admin-today-chart-pop">
      <div className="admin-today-chart-inner">
        <p className="admin-today-chart-title">
          Por horário
          {peakCount > 0 && (
            <span className="admin-today-chart-peak"> &middot; pico às {peakHour}h ({peakCount})</span>
          )}
        </p>
        <svg
          className="admin-today-chart-svg"
